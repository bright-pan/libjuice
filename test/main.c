...
static void test_juice_entry(void *param) {
...
static void test_juice(int argc, char **argv) {
	aos_task_new("test_juice", test_juice_entry, NULL, 500*1024);
}

ALIOS_CLI_CMD_REGISTER(test_juice, test_juice, test_juice);
#endif
