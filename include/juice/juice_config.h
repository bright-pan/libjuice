...
#define RTP_PACKETIZER_BUF_SIZE (CONFIG_MTU + 16)
#define RTP_TX_CACHE_TIMEOUT_CHECK 300 //1000/30)
#define RTP_TX_CACHE_TIMEOUT 1500

#define RTP_FRAME_PACKET_MAX_SIZE RTP_PACKETIZER_BUF_SIZE
#define RTP_TX_CACHE_LIST_MAX_SIZE 512
#define RTP_RTX_CACHE_LIST_MAX_SIZE 64
