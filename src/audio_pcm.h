...
#define PCM_CAPTURE_HW_PARAMS_PERIOD_SIZE (480)// 25fps(40ms/packet) sample window size
...
#define PCM_PLAY_HW_PARAMS_PERIOD_SIZE 640 // 10fps(100ms/packet) play window size
